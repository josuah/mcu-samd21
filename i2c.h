...
#define I2C0M ((struct mcu_i2c_master *)SERCOM0_BASE)
#define I2C0S ((struct mcu_i2c_slave *)SERCOM0_BASE)
#define I2C1M ((struct mcu_i2c_master *)SERCOM1_BASE)
#define I2C1S ((struct mcu_i2c_slave *)SERCOM1_BASE)
#define I2C2M ((struct mcu_i2c_master *)SERCOM2_BASE)
#define I2C2S ((struct mcu_i2c_slave *)SERCOM2_BASE)
#define I2C3M ((struct mcu_i2c_master *)SERCOM3_BASE)
#define I2C3S ((struct mcu_i2c_slave *)SERCOM3_BASE)
#define I2C4M ((struct mcu_i2c_master *)SERCOM4_BASE)
#define I2C4S ((struct mcu_i2c_slave *)SERCOM4_BASE)
#define I2C5M ((struct mcu_i2c_master *)SERCOM5_BASE)
#define I2C5S ((struct mcu_i2c_slave *)SERCOM5_BASE)
