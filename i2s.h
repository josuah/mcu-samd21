...
#define I2S ((struct mcu_i2s *)0x42005000)
#define I2S ((struct mcu_i2s *)0x42005000)
...
#define I2S_CLKCTRLn_MCKOUTDIV_MASK		I2S_CLKCTRLn_MCKOUTDIV(B00011111)
#define I2S_CLKCTRLn_MCKDIV(x)			((x) << 19)
#define I2S_CLKCTRLn_MCKDIV_MASK		I2S_CLKCTRLn_MCKDIV(B00011111)
...
#define I2S_CLKCTRLn_FSWIDTH_MASK		I2S_CLKCTRLn_FSWIDTH(B00000011)
#define I2S_CLKCTRLn_NBSLOTS(x)			((x) << 2)
#define I2S_CLKCTRLn_NBSLOTS_MASK		I2S_CLKCTRLn_NBSLOTS(B00000111)
#define I2S_CLKCTRLn_SLOTSIZE(x)		((x) << 0)
#define I2S_CLKCTRLn_SLOTSIZE_MASK		I2S_CLKCTRLn_SLOTSIZE(B00000011)
...
#define I2S_SERCTRLn_EXTEND_MASK		I2S_SERCTRLn_EXTEND(B00000011)
#define I2S_SERCTRLn_WORDADJ			(1u << 12)
#define I2S_SERCTRLn_DATASIZE(x)		((x) << 8)
#define I2S_SERCTRLn_DATASIZE_MASK		I2S_SERCTRLn_DATASIZE(B00000111)
...
#define I2S_SERCTRLn_TXDEFAULT_MASK		I2S_SERCTRLn_TXDEFAULT(B00000011)
#define I2S_SERCTRLn_SERMODE(x)			((x) << 0)
#define I2S_SERCTRLn_SERMODE_MASK		I2S_SERCTRLn_SERMODE(B00000011)
