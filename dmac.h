...
#define DMAC_PRICTRL0_LVLPRI3_MASK		DMAC_PRICTRL0_LVLPRI3(B00001111)
#define DMAC_PRICTRL0_RRLVLEN2			(1u << 23)
#define DMAC_PRICTRL0_LVLPRI2(x)		((x) << 16)
#define DMAC_PRICTRL0_LVLPRI2_MASK		DMAC_PRICTRL0_LVLPRI2(B00001111)
#define DMAC_PRICTRL0_RRLVLEN1			(1u << 15)
#define DMAC_PRICTRL0_LVLPRI1(x)		((x) << 8)
#define DMAC_PRICTRL0_LVLPRI1_MASK		DMAC_PRICTRL0_LVLPRI1(B00001111)
#define DMAC_PRICTRL0_RRLVLEN0			(1u << 7)
#define DMAC_PRICTRL0_LVLPRI0(x)		((x) << 0)
#define DMAC_PRICTRL0_LVLPRI0_MASK		DMAC_PRICTRL0_LVLPRI0(B00001111)
...
#define DMAC_INTPEND_ID_MASK			DMAC_INTPEND_ID(B00001111)
...
#define DMAC_CHID_ID_MASK			DMAC_CHID_ID(B00001111)
...
#define DMAC_CHCTRLB_TRIGSRC_MASK		DMAC_CHCTRLB_TRIGSRC(B00111111)
...
#define DMAC_BTCTRL_STEPSIZE_MASK		DMAC_BTCTRL_STEPSIZE(B00000111)
...
#define DMAC_BTCTRL_BEATSIZE_MASK		DMAC_BTCTRL_BEATSIZE(B00000011)
#define DMAC_BTCTRL_BLOCKACT(x)			((x) << 3)
#define DMAC_BTCTRL_BLOCKACT_MASK		DMAC_BTCTRL_BLOCKACT(B00000011)
#define DMAC_BTCTRL_EVOSEL(x)			((x) << 1)
#define DMAC_BTCTRL_EVOSEL_MASK			DMAC_BTCTRL_EVOSEL(B00000011)
