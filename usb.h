...
#define USB_QOSCTRL_DQOS_MASK			USB_QOSCTRL_DQOS(B00000011)
#define USB_QOSCTRL_CQOS(x)			((x) << 0)
#define USB_QOSCTRL_CQOS_MASK			USB_QOSCTRL_CQOS(B00000011)
...
#define USB_FSMSTATUS_FSMSTATE_MASK		USB_FSMSTATUS_FSMSTATE(B01111111)
...
#define USB_PADCAL_TRIM_MASK			USB_PADCAL_TRIM(B00000111)
#define USB_PADCAL_TRANSN(x)			((x) << 6)
#define USB_PADCAL_TRANSN_MASK			USB_PADCAL_TRANSN(B00011111)
#define USB_PADCAL_TRANSP(x)			((x) << 0)
#define USB_PADCAL_TRANSP_MASK			USB_PADCAL_TRANSP(B00011111)

	/* 0x08: Control B */
	uint16_t volatile CTRLB;
#define USB_CTRLB_LPMHDSK(x)			((x) << 10)
#define USB_CTRLB_LPMHDSK_MASK			USB_CTRLB_LPMHDSK(B00000011)
#define USB_CTRLB_GNAK				(1u << 9)
#define USB_CTRLB_NREPLY			(1u << 4)
#define USB_CTRLB_SPDCONF(x)			((x) << 2)
#define USB_CTRLB_SPDCONF_MASK			USB_CTRLB_SPDCONF(B00000011)
...
#define USB_DADD_DADD_MASK			USB_DADD_DADD(B01111111)
	...
	uint8_t volatile STATUS;
#define USB_STATUS_LINESTATE(x)			((x) << 6)
#define USB_STATUS_LINESTATE_MASK		USB_STATUS_LINESTATE(B00000011)
#define USB_STATUS_SPEED(x)			((x) << 2)
#define USB_STATUS_SPEED_MASK			USB_STATUS_SPEED(B00000011)
...
#define USB_FNUM_MFNUM_MASK			USB_FNUM_MFNUM(B00000111)
...
#define USB_EPCFGn_EPTYPE1_MASK			USB_EPCFGn_EPTYPE1(B00000111)
#define USB_EPCFGn_EPTYPE0(x)			((x) << 0)
#define USB_EPCFGn_EPTYPE0_MASK			USB_EPCFGn_EPTYPE0(B00000111)
...
#define USB_PCKSIZE_AUTO_ZLP			(1u << 31)
#define USB_PCKSIZE_SIZE(x)			((x) << 28)
#define USB_PCKSIZE_SIZE_MASK			USB_PCKSIZE_SIZE(B00000111)
#define USB_PCKSIZE_MULTI_PACKET_SIZE(x)	((x) << 14)
#define USB_PCKSIZE_BYTE_COUNT(x)		((x) << 8)
#define USB_PCKSIZE_BYTE_COUNT_MASK		USB_PCKSIZE_BYTE_COUNT(B00111111)

	/* 0x08: Extended Register */
	uint16_t volatile EXTREG;
#define USB_EXTREG_VARIABLE(x)			((x) << 4)
#define USB_EXTREG_SUBPID(x)			((x) << 0)
#define USB_EXTREG_SUBPID_MASK			USB_EXTREG_SUBPID(B00001111)
...
#define USB_STATUS_BK_CRCERR			(1u << 0)
	...
	uint16_t volatile CTRL_PIPE;
#define USB_CTRL_PIPE_PERMAX(x)			((x) << 12)
#define USB_CTRL_PIPE_PERMAX_MASK		USB_CTRL_PIPE_PERMAX(B00001111)
#define USB_CTRL_PIPE_PEPNUM(x)			((x) << 8)
#define USB_CTRL_PIPE_PEPNUM_MASK		USB_CTRL_PIPE_PEPNUM(B00001111)
#define USB_CTRL_PIPE_PDADDR(x)			((x) << 0)
#define USB_CTRL_PIPE_PDADDR_MASK		USB_CTRL_PIPE_PDADDR(B01111111)

	/* 0x0E: Host Status Pipe */
	uint16_t volatile STATUS_PIPE;
#define USB_STATUS_PIPE_ERCNT(x)		((x) << 5)
#define USB_STATUS_PIPE_ERCNT_MASK		USB_STATUS_PIPE_ERCNT(B00000111)
#define USB_STATUS_PIPE_CRC16ER			(1u << 4)
#define USB_STATUS_PIPE_TOUTER			(1u << 3)
#define USB_STATUS_PIPE_PIDER			(1u << 2)
#define USB_STATUS_PIPE_DAPIDER			(1u << 1)
